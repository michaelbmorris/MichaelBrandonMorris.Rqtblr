...
using MichaelBrandonMorris.Rqtblr.Extensions;
using MichaelBrandonMorris.Rqtblr.Models;
using MichaelBrandonMorris.Rqtblr.Models.ManageViewModels;
...
namespace MichaelBrandonMorris.Rqtblr.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> ChangePassword()
        {
            ...
            var model =
                new ChangePasswordViewModel {StatusMessage = StatusMessage};
            return View(model);
        }
        ...
        public async Task<IActionResult> Disable2fa()
        {
            ...
            _logger.LogInformation(
                "User with ID {UserId} has disabled 2fa.", user.Id);
        ...
        public async Task<IActionResult> ExternalLogins()
        {
            ...
            model.OtherLogins =
                ...
                .Where(
                    auth => model.CurrentLogins.All(
                        ul => auth.Name != ul.LoginProvider))
                .ToList();
        ...
        public async Task<IActionResult> SetPassword()
        {
            ...
            var model =
                new SetPasswordViewModel {StatusMessage = StatusMessage};
            return View(model);
        }
        ...
        public IActionResult ShowRecoveryCodes()
        {
            ...
            var model =
                new ShowRecoveryCodesViewModel {RecoveryCodes = recoveryCodes};
            return View(model);
        }
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("MichaelBrandonMorris.Rqtblr"),
